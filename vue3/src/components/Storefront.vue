  ...
  <div class="bg-white">
                  ...
                  <div class="grid grid-cols-2 gap-x-4 gap-y-10">
                    <div v-for="item in category.featured" :key="item.name" class="group relative">
                      <div class="rounded-md overflow-hidden group-hover:opacity-75">
												<TwicImg :src="item.imageSrc" :alt="item.imageAlt" placeholder="meancolor" />
                      </div>
    ...
    <div class="relative bg-gray-900">
      <!-- Decorative image and overlay -->
				<div class="sm:hidden">
					<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-hero-full-width.jpeg" ratio="1/2" alt="" />
				</div>

				<div class="hidden sm:block md:hidden">
					<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-hero-full-width.jpeg" alt="" />
				</div>

				<div class="hidden md:block xl:hidden">
					<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-hero-full-width.jpeg" ratio="4/3" alt="" />
				</div>

				<div class="hidden xl:block">
					<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-hero-full-width.jpeg" ratio="16/9" alt="" />
				</div>
      <div aria-hidden="true" class="absolute inset-0 bg-gray-900 opacity-50" />

      <!-- Navigation -->
      <header class="absolute z-10 top-0 w-full">
				<div class="flex justify-center text-white bg-twicpics">
					<h1 class="flex items-center">
						<img class="h-8 object-contain" src="../assets/twicpics-logo.svg" alt="TwicPics logo" />
						<span class="ml-3 mr-1">x</span>
						<img class="h-12 object-contain" src="../assets/vue-logo.png" alt="Vue.JS logo" />
					</h1>
				</div>
        <nav aria-label="Top">
          <!-- Top navigation -->
      ...
      <div class="absolute top-0 left-0 right-0 bottom-0 max-w-3xl mx-auto py-32 pt-48 px-6 flex flex-col justify-center items-center text-center">
    ...
    <main>
          ...
          <div class="-my-2">
            <div class="box-content py-2 relative h-80 overflow-x-auto xl:overflow-visible">
              <div class="absolute min-w-screen-xl px-4 flex space-x-8 sm:px-6 lg:px-8 xl:relative xl:px-0 xl:space-x-0 xl:grid xl:grid-cols-5 xl:gap-x-8">
                <a v-for="category in categories" :key="category.name" :href="category.href" class="relative w-56 rounded-lg overflow-hidden hover:opacity-75 xl:w-auto">
									<TwicImg :src="category.imageSrc" alt="" ratio="7/10" />
                  <span aria-hidden="true" class="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-gray-800 opacity-50" />
                  <span class="absolute z-10 bottom-0 mt-auto p-6 w-full text-center text-xl font-bold text-white">{{ category.name }}</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <section aria-labelledby="social-impact-heading" class="max-w-7xl mx-auto pt-24 px-4 sm:pt-32 sm:px-6 lg:px-8">
        <div class="relative rounded-lg overflow-hidden">
					<div class="sm:hidden">
						<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-01.jpeg" ratio="1/2" alt="" />
					</div>

					<div class="hidden sm:block md:hidden">
						<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-01.jpeg" alt="" />
					</div>

					<div class="hidden md:block xl:hidden">
						<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-01.jpeg" ratio="16/9" alt="" />
					</div>

					<div class="hidden xl:block">
						<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-01.jpeg" ratio="2/1" alt="" />
					</div>
          <div class="absolute top-0 left-0 flex items-center w-full h-full bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
      ...
      <section aria-labelledby="collection-heading" class="max-w-xl mx-auto pt-24 px-4 sm:pt-32 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div class="mt-10 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8">
          <a v-for="collection in collections" :key="collection.name" :href="collection.href" class="group block">
            <div aria-hidden="true" class="rounded-lg overflow-hidden group-hover:opacity-75">
							<TwicImg :src="collection.imageSrc" :alt="collection.imageAlt" />
            </div>
      ...
      <section aria-labelledby="comfort-heading" class="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        <div class="relative rounded-lg overflow-hidden">
					<div class="sm:hidden">
						<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-02.jpeg" ratio="1/2" alt="" />
					</div>

					<div class="hidden sm:block md:hidden">
						<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-02.jpeg" alt="" />
					</div>

					<div class="hidden md:block xl:hidden">
						<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-02.jpeg" ratio="16/9" alt="" />
					</div>

					<div class="hidden xl:block">
						<TwicImg src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-02.jpeg" ratio="2/1" alt="" />
					</div>
          <div class="absolute top-0 left-0 flex items-center w-full h-full bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
            <div class="relative max-w-3xl mx-auto flex flex-col items-center text-center">
      ...
      featured: [
        {
          name: 'New Arrivals',
          href: '#',
          imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/mega-menu-category-01.jpeg',
          imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
        },
        {
          name: 'Basic Tees',
          href: '#',
          imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/mega-menu-category-02.jpeg',
          imageAlt: 'Close up of Basic Tee fall bundle with off-white, ochre, olive, and black tees.',
        },
        {
          name: 'Accessories',
          href: '#',
          imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/mega-menu-category-03.jpeg',
          imageAlt: 'Model wearing minimalist watch with black wristband and white watch face.',
        },
        {
          name: 'Carry',
          href: '#',
          imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/mega-menu-category-04.jpeg',
      ...
      featured: [
        {
          name: 'New Arrivals',
          href: '#',
          imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/mega-menu-01-men-category-01.jpeg',
          imageAlt: 'Hats and sweaters on wood shelves next to various colors of t-shirts on hangers.',
        },
        {
          name: 'Basic Tees',
          href: '#',
          imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/mega-menu-01-men-category-02.jpeg',
          imageAlt: 'Model wearing light heather gray t-shirt.',
        },
        {
          name: 'Accessories',
          href: '#',
          imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/mega-menu-01-men-category-03.jpeg',
          imageAlt:
        ...
        },
        {
          name: 'Carry',
          href: '#',
          imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/mega-menu-01-men-category-04.jpeg',
...
const categories = [
  {
    name: 'New Arrivals',
    href: '#',
    imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-category-01.jpeg',
  },
  {
    name: 'Productivity',
    href: '#',
    imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-category-02.jpeg',
  },
  {
    name: 'Workspace',
    href: '#',
    imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-category-04.jpeg',
  },
  {
    name: 'Accessories',
    href: '#',
    imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-category-05.jpeg',
  },
  { name: 'Sale', href: '#', imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-category-03.jpeg' },
]
const collections = [
  {
    name: 'Handcrafted Collection',
    href: '#',
    imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-collection-01.jpeg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-collection-02.jpeg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: 'https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-collection-03.jpeg',
