<template>
  <div class="bg-white">
              ...
              <TabPanels as="template">
                ...
                >
                  <div class="grid grid-cols-2 gap-x-4 gap-y-10">
                    ...
                    >
                      <div
                        class="rounded-md overflow-hidden group-hover:opacity-75"
                      >
                        <TwicImg
                          :src="item.imageSrc"
                          :alt="item.imageAlt"
    ...
    <div class="relative bg-gray-900">
      ...
      <div
        class="absolute top-0 left-0 right-0 bottom-0 max-w-3xl mx-auto py-32 pt-48 px-6 flex flex-col justify-center items-center text-center"
      >
        <h1
    ...
    <main>
      ...
      >
        ...
        <div class="mt-4 flow-root">
          <div class="-my-2">
            <div
              class="box-content py-2 relative h-80 overflow-x-auto xl:overflow-visible"
            >
              <div
              ...
              >
                <a
                  ...
                  :key="category.name"
                  :href="category.href"
                  class="relative w-56 rounded-lg overflow-hidden hover:opacity-75 xl:w-auto"
                >
                  ...
                  />
                  <span
                    class="absolute z-10 bottom-0 mt-auto p-6 w-full text-center text-xl font-bold text-white"
                    >{{ category.name }}</span
                  >
                </a>
              </div>
      ...
      >
        <div class="relative rounded-lg overflow-hidden">
          ...
          <div
            class="absolute top-0 left-0 flex items-center w-full h-full bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16"
          >
            <div
      ...
      >
        ...
        >
          ...
          >
            <div
              aria-hidden="true"
              class="rounded-lg overflow-hidden group-hover:opacity-75"
            >
