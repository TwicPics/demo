...
function App() {
  ...
  return (
    <div className="App">
      <Head>
        <title>TwicPics x Next: Storefront</title>
      ...
      <div className="bg-white">
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-10">
                          {category.featured.map((item) => (
                            <div key={item.name} className="group relative">
                              <div className="rounded-md overflow-hidden group-hover:opacity-75">
                                <TwicImg
                                  src={item.imageSrc}
                                  alt={item.imageAlt}
        ...
        <div className="relative bg-gray-900">
          ...
          <div className="sm:hidden">
            <TwicImg
              src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-hero-full-width.jpeg"
              ratio="1/2"
              alt=""
            />
          </div>
          ...
          <header className="absolute z-10 top-0 w-full">
            <div className="flex justify-center text-white bg-twicpics">
              <h1 className="flex items-center space-x-3">
                <img className="h-8 object-contain" src="/images/twicpics-logo.svg" alt="TwicPics logo" />
                <span>x</span>
                <img className="h-12 object-contain" src="/images/next-logo.png" alt="Next logo" />
              </h1>
            </div>
            <nav aria-label="Top">
              {/* Top navigation */}
          ...
          <div className="absolute top-0 left-0 right-0 bottom-0 max-w-3xl mx-auto py-32 pt-48 px-6 flex flex-col justify-center items-center text-center">
        ...
        <main>
                  ...
                  <div className="absolute min-w-screen-xl px-4 flex space-x-8 sm:px-6 lg:px-8 xl:relative xl:px-0 xl:space-x-0 xl:grid xl:grid-cols-5 xl:gap-x-8">
                    {categories.map((category) => (
                      <a
                        key={category.name}
                        href={category.href}
                        className="relative w-56 rounded-lg overflow-hidden hover:opacity-75 xl:w-auto"
                      >
                        <TwicImg src={category.imageSrc} ratio="7/10" />
                        <span
                          aria-hidden="true"
                          className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-gray-800 opacity-50"
                        />
                        <span className="absolute z-10 bottom-0 mt-auto p-6 w-full text-center text-xl font-bold text-white">
                          {category.name}
                        </span>
                      </a>
                    ))}
          ...
          >
            <div className="relative rounded-lg overflow-hidden">
              <div className="sm:hidden">
                <TwicImg
                  src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-01.jpeg"
                  ratio="1/2"
                  alt=""
                />
              </div>
              ...
              <div className="absolute top-0 left-0 flex items-center w-full h-full bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
          ...
          >
            <div className="relative rounded-lg overflow-hidden">
              <div className="sm:hidden">
                <TwicImg
                  src="https://assets.twicpics.com/demo/fake-websites/homepage/home-page-01-feature-section-02.jpeg"
                  ratio="1/2"
                  alt=""
                />
              </div>
